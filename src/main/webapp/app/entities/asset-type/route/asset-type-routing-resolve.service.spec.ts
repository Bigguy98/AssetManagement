...
describe('AssetType routing resolve service', () => {
  ...
  let routingResolveService: AssetTypeRoutingResolveService;
  let service: AssetTypeService;
  let resultAssetType: IAssetType | undefined;
  ...
  beforeEach(() => {
    ...
    routingResolveService = TestBed.inject(AssetTypeRoutingResolveService);
  ...
  describe('resolve', () => {
    ...
    it('should return new IAssetType if id is not provided', () => {
      // GIVEN
      ...
      expect(resultAssetType).toEqual(new AssetType());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as AssetType })));
      mockActivatedRouteSnapshot.params = { id: 123 };
