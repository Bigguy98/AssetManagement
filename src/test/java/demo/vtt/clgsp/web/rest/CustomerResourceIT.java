...
import demo.vtt.clgsp.repository.CustomerRepository;
...
class CustomerResourceIT {
    ...
    void putNewCustomer() throws Exception {
        ...
        updatedCustomer.name(UPDATED_NAME).dateOfBirth(UPDATED_DATE_OF_BIRTH).address(UPDATED_ADDRESS).bankAccount(UPDATED_BANK_ACCOUNT);
